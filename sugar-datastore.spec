...
Source: http://download.sugarlabs.org/sources/sucrose/glucose/sugar-datastore/sugar-datastore-0.85.3.tar.bz2

Requires: python-dbus  
Requires: python  
Requires: python-cjson  
Requires: sugar-base >= 0.85.5
...
%prep
%setup -q -n sugar-datastore-0.85.3
